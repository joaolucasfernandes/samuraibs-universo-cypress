...
describe('login', function () {
    ...
    context('quando usuário é muito bom', function () {
        ...
        before(function () {    //mata o usuario. Usado para garantir que massa alterada nao estrague o teste
            cy.postUser(user)  ///função está no arquivo coomands.js
        })
    ...
    context('quando o usuário é bom mas a senha está incorreta', function () {
        ...
        let user = {            //variaveis que poderão variar
            name: 'Celso Kamura',
        ...
        before(function () {
            cy.postUser(user).then(function () {   //feito para que o js não execute os dois códigos ao mesmo tempo
